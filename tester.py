...
if __name__ == '__main__':
    ...
    """
    Draw robots step in maze
    """
    mazeObj= DrawMaze(testmaze)
    ...
    for run in range(2):
        ...
        while run_active:
            ...
            while movement:
                ...
                if(not dir_changed):
                        mazeObj.changeDirection(rotation ,robot_pos['heading'] )
                        dir_changed = True
                ...
                if movement > 0:
                    ...
                    if testmaze.is_permissible(robot_pos['location'], robot_pos['heading']):
                        ...
                        movement -= 1
                        mazeObj.drawSearchPath(robot_pos['location'][0],robot_pos['location'][1],'u' )
    ...
    if len(runtimes) == 2:
        print("Test! Score: {:4.3f}".format(runtimes[1]))
        print("Train! Score: {:4.3f}".format(train_score_mult*runtimes[0]))
